...
class Admin::CommentsControllerTest < ActionController::TestCase
  ...
  test "should create admin_comment" do
    assert_difference('Admin::Comment.count') do
      post :create, admin_comment: { author: @admin_comment.author, author_id: @admin_comment.author_id, author_location: @admin_comment.author_location, email: @admin_comment.email, status: @admin_comment.status, text: @admin_comment.text }
    end
  ...
  test "should update admin_comment" do
    patch :update, id: @admin_comment, admin_comment: { author: @admin_comment.author, author_id: @admin_comment.author_id, author_location: @admin_comment.author_location, email: @admin_comment.email, status: @admin_comment.status, text: @admin_comment.text }
    assert_redirected_to admin_comment_path(assigns(:admin_comment))
  end
