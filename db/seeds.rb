...
Static.create!({
  ...
  html: '<p>Пока нам некого благодарить :(</p><p>Но в скором времени здесь появиться много имен и адресов (мы надеемся). Если Вы считаете, что как-то можете помочь проекту, пожалуйста, напишите нам вот сюда: "<a href="mailto:warinukraine@gmail.com">warinukraine.info@gmail.com</a>".</p>'
})
